    ...
    <div class="builder-subsection">
      <div class="builder-subsection-head">
        <div>
          ...
          <p>Hanya pertanyaan yang belum digunakan survei lain yang ditampilkan.</p>
        </div>
      ...
      <?php else: ?>
        <div class="builder-empty-state">Belum ada pertanyaan bebas. Gunakan pembuat pertanyaan baru di bawah.</div>
      <?php endif; ?>
    </div>
